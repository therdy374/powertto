            ...
            <form action="" method="POST">
                <div class="modal-header">
                    <h5 class="modal-title d-flex align-items-center text-warning">
                        <i class="bi bi-person-fill-add me-2"></i>Login Information
                    </h5>
                ...
                <div class="modal-body">
                    <span class="badge rounded-pill bg-secondary text-danger mb-3 text-wrap lh-base">
                        Note: This is the logs information of the users access!
                    </span>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-md-12 ps-0 mb-3 text-white">
                                <label class="form-label">User Access: <span>
                                        <?php
                                        if ($status == 1) {
                            ...
                            <div class="col-md-12 ps-0 mb-3 text-white">
                                <label class="form-label">Date Logged In: <span><?php echo $date_logs ?></span></label>
                            </div>
                            <div class="col-md-12 ps-0 mb-3 text-white">
                                <label class="form-label">Date Logged Out:
                                    <span>
                                        <?php
                                        if ($status == 1) {
                                            echo "Still in use!";

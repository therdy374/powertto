    ...
    <div class="row g-4">
        <div class="col-sm-12">
            <div class="bg-secondary rounded h-100 p-4">
                <h6 class="mb-4 text-center">Terms and Condition</h6>
                ...
                <div class="table-responsive text-center">
                    <table class="table table-bordered text-white text-center my-3" style="font-size: small;" id="myTable">
                        ...
                        <tbody>
                            ...
                            $get_users = "Select * from `terms_condition` order by `date_create` DESC";
                            ...
                            while ($run_query = mysqli_fetch_array($result_query)) {
                                ...
                                $created_at = date('Y.m.d (D) h:i:s(A)', strtotime($run_query['date_create']))
                            ...
                            ?>
                                ...
                                <tr class='text-center'>
                                    ...
                                    <td><a href='index.php?update_terms=<?php echo $id ?>' class='text-success'><i class="fa-sharp fa-solid fa-user-plus"></i></a></td>

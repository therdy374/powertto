    ...
    <div class="row g-4">
        <div class="col-sm-12">
            <div class="bg-secondary rounded h-100 p-4">
                <div>
                    <h6 class="mb-4 text-center">User Double Login Info
                    ...
                    <table class="table table-bordered text-white text-center" style="font-size: small;" id="myTable">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">Logs Problem</th>
                        ...
                        <tbody>
                            <?php
                            $get_users = "SELECT * FROM login_double ORDER BY `date_logs` DESC";
                            ...
                            ?>
                                <tr>
                                    <td><?php echo $id ?></td>
                                    <?php
                                    include "./data/double_login_modal.php";
                                    ?>

                                    <td>
                                        <a href="#double_logs<?php echo $id ?>" data-bs-toggle="modal"><?php echo $userid ?></a>
                                    </td>
                                    ...
                                    <td>
                                        <a href='index.php?delete_double_logs=<?php echo $id ?>' class='text-danger'>

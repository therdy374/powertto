    ...
    <div class="row g-4">
        <div class="col-sm-12">
            <div class="bg-secondary rounded h-100 p-4">
                <h6 class="mb-4 text-center text-primary">에이전트 목록 L1</h6>
                <?php include_once("./data/admin_new_modal_L2.php");
                ?>
                <div class="d-flex">
                    <a href="#add_admin" class="btn btn-primary text-light btn-sm mx-0 my-2" data-bs-toggle="modal"><i class="bi bi-plus-square me-2"></i>새 에이전트</a>
                </div>
                <div class="table-responsive text-center">
                    <table class="table table-bordered text-white" style="font-size: small;" id="myTable">
                        ...
                        <tbody>
                            ...
                            $get_users = "Select * from `admins` Where parent_name = '$referal_codes' and admin_level= '1' order by `created_at` DESC";
                            ...
                            ?>
                                <tr class='text-center'>
                                    ...
                                    <td>
                                        <?php echo $email; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href='index_L2.php?admin_edit=<?php echo $id ?>' class='text-success'>
                                    ...
                                    <td><a href='index_L2.php?users_affiliated=<?php echo $referal_code ?>' class='text-success'><i class='fa-solid fa-pen-to-square'></i></a></td>
                                    <td><a href='index_L2.php?delete_admin=<?php echo $id ?>' class='text-danger'><i class='fa-solid fa-trash-can'></i></a></td>
                                </tr>
                            <?php
                            }
                            ?>
                    ...
                    <script>
                        function updateAction(selectElement, userId) {
                            ...
                            if (selectedOption === "view") {
                                form.action = "index_L2.php?users_affiliated=<?php echo $id ?>";
                            } else {

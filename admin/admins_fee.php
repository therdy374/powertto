    ...
    <div class="row g-4">
        <div class="col-sm-12">
            <div class="bg-secondary rounded h-100 p-4">
                <strong>
                    <h6 class="mb-4 text-center text-primary">1일 수수료 내역</h6>
                </strong>
                    ...
                    <table class="table table-bordered text-white text-center my-3" style="font-size: small;" id="myTable">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">1일 총 수수료</th>
                        ...
                        <tbody>
                            ...
                            $get_users = "SELECT *, SUM(admin_fee) AS total_winning_amount FROM admins_fee GROUP BY DATE(date_purchase) ORDER BY `date_purchase` ASC";

                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0" style="font-size: small;">
                            ...
                            <!-- <a href="index_L3.php?user_deposit_request3" class="dropdown-item">Deposit Record</a> -->
                            <a href="index_L3.php?deposit_users" class="dropdown-item">입금내역</a>
                            <a href="index_L3.php?view_users_withdrawal" class="dropdown-item">출금내역</a>
                            <a href="index_L3.php?new_ListPurchase" class="dropdown-item">구매내역</a>
                            <a href="index_L3.php?codeWinners" class="dropdown-item">Code Winners</a>
                            <a href="index_L3.php?users_affiliated" class="dropdown-item">All Subscriber List</a>
                            <a href="index_L3.php?view_admin_L3" class="dropdown-item">All Agent List</a>
                            <a href="index_L3.php?view_admin_L2" class="dropdown-item">Agent Level 2</a>
                            <a href="index_L3.php?view_admin_L1" class="dropdown-item">Agent Level 1</a>

    ...
    <div class="row g-4">
        <div class="col-sm-12">
            <div class="bg-secondary rounded h-100 p-4">
                <h6 class="mb-4 text-center text-primary">에이전트 목록 L2</h6>
                ...
                <div class="table-responsive text-center">
                    <table class="table table-bordered text-white" style="font-size: small;" id="myTable">
                        ...
                        <tbody>
                            ...
                            $get_users = "Select * from `admins` Where parent_name = '$referal_codes' and admin_level = '2' order by `created_at` DESC";

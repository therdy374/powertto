    ...
    <div class="row g-4">
        <div class="col-sm-12">
            <div class="bg-secondary rounded h-100 p-4">
                ...
                <?php //include_once("./data/admin_new_modal_L1.php");
                ?>
                <div class="d-flex">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr class='text-center'>
                                    ...
                                    <td>
                                        <?php echo $username; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href='index_L3.php?admin_edit=<?php echo $id ?>' class='text-success'>
                                    ...
                                    <td><a href='index_L3.php?users_affiliated=<?php echo $referal_code ?>' class='text-success'><i class='fa-solid fa-pen-to-square'></i></a></td>
                                    <td><a href='index_L3.php?delete_admin=<?php echo $id ?>' class='text-danger'><i class='fa-solid fa-trash-can'></i></a></td>
                                </tr>
                            <?php
                            }
                            ?>
                    ...
                    <script>
                        function updateAction(selectElement, userId) {
                            ...
                            if (selectedOption === "view") {
                                form.action = "index_L1.php?users_affiliated=<?php echo $id ?>";
                            } else {

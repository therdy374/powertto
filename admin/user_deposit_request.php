                ...
                <div class="table-responsive text-center">
                    <table class="table text-white text-center my-3" style="font-size: small;" id="myTable">
                        ...
                        <tbody>
                            ...
                            $get_users = "Select * from `users_request_deposit` order by `date_message` DESC";
                            ...
                            if (isset($_POST['action']) && isset($_POST['id'])) {
                                ...
                                if ($action == 'Confirm') {
                                    ...
                                    $user_update = "INSERT INTO deposit_mgt (referal_code, name, user_id, amount_deposit, status, date_deposit, userid) VALUES ('$referal_code', '$name','$user_id','$amount_deposit', 'Completed', '$currentDateTime','$userid')";

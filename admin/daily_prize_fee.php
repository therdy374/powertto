    ...
    <div class="row g-4">
        <div class="col-sm-12">
            <div class="bg-secondary rounded h-100 p-4">
                <strong>
                    <h6 class="mb-4 text-center text-primary">1일 상금 내역</h6>
                </strong>
                ...
                <div class="table-responsive text-center">
                    <table class="table table-bordered text-white text-center my-3" style="font-size: small;" id="myTable">
                        ...
                        <tbody>
                            ...
                            $get_users = "SELECT *, SUM(winning_amount) AS total_winning_amount FROM user_purchases GROUP BY DATE(date_purchase) ORDER BY `date_purchase` ASC";
                            ...
                            while ($run_query = mysqli_fetch_array($result_query)) {
                                ...
                                $total_winning_amount = $run_query['total_winning_amount'];

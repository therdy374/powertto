            ...
            <div class="bg-secondary rounded h-100 p-4">
                ...
                ?>
                    <h6 class="mb-4 text-left text-primary">
                        ...
                        <a href="index.php?view_admin" class="btn btn-primary float-end">BACK</a>
                    </h6>
                    <br>
                <?php
                } else {
                    echo '<h6 class="mb-4 text-left text-primary">Users Affiliated <a href="index.php?view_admin" class="btn btn-primary float-end">BACK</a></h6><br>';
                }
                ?>
                    ...
                    <table class="table table-bordered text-white text-center" style="font-size: small;" id="myTable">
                        ...
                        <tbody>
                            ...
                            if (isset($_GET['users_affiliated'])) {
                                ...
                                $sql = "SELECT * FROM users WHERE referal_code = '$user_id'";

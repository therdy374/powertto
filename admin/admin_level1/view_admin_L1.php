                        ...
                        <tbody>
                            ...
                            ?>
                                <tr class='text-center'>
                                    ...
                                    <td>
                                        <?php echo $username; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href='index_L1.php?admin_edit=<?php echo $id ?>' class='text-success'>
                                    ...
                                    <td><a href='index_L1.php?users_affiliated=<?php echo $referal_code ?>' class='text-success'><i class='fa-solid fa-pen-to-square'></i></a></td>
                                    <td><a href='index_L1.php?delete_admin=<?php echo $id ?>' class='text-danger'><i class='fa-solid fa-trash-can'></i></a></td>
                                </tr>
                            <?php
                            }
                            ?>

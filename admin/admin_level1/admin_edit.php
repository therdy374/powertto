        ...
        <div class="bg-secondary rounded h-100 p-4">
            ...
            <div>
                <h6 class="mb-4 text-primary">Agents Update
                    <a href="index_L1.php?view_admin_L1" class="btn btn-primary btn-sm float-end">Back</a>
                </h6>
            </div>
            <form action="" method="POST" class="mb-2">
                <div class="row">
                    <input type="hidden" name="id" value="<?php echo $user_id; ?>" class="form-control" readonly />

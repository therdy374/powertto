    ...
    <div class="wrap">
        ...
        <header>
            <?php if (isset($_SESSION['loggedIn'])) :  ?>
                ...
                <div class="my-info">
                    ...
                    <span class="ml10">
                        ...
                        <a href="#">₩ <?php echo $formatted_credit; ?></a>
                        <!-- <a href="user_request_deposit.php" class="btn-point" title="포인트충전">포인트충전</a> -->
                        <a href="purchase_details" title="구매내역" class="btn-point">구매내역</a>
                        <a href="winning_details" title="당첨내역" class="btn-point">당첨내역</a>
                    </span>
                ...
                <div class="max-wrapper">
                    <h1 class="gnb-logo">
                        <a href="index" title="로또캠프"><img src="asset/images/powerTTO2.jpg" alt="로또캠프" /></a>
                    </h1>
                    ...
                    <nav class="gnb">
                        <div class="my-info-mo">
                            <div>
                                <a href="user_request_withdrawal" class="name"></a>환영해요 <?= $_SESSION['loggedInUser']['name']; ?> 님! 반갑습니다.
                        ...
                        <ul class="gnb-menu">
                            <li class="menu-item">
                                ...
                                <ul class="depth2">
                                    <li><a href="lotto_pb" title="파워또">파워또</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="menu-item">
                                ...
                                <ul class="depth2">
                                    <li><a href="list_purchase" title="참여리스트">참여리스트</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="menu-item">
                                ...
                                <ul class="depth2">
                                    <li><a href="winners_board" title="당첨자게시판">당첨자게시판</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="menu-item">
                                ...
                                <ul class="depth2">
                                    <li><a href="winning_statistics" title="당첨번호&통계">당첨번호&통계</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="menu-item">
                                ...
                                <ul class="depth2">
                                    <li><a href="user_depositform" title="보증금">입금신청</a></li>
                                    <li><a href="user_withdrawalform" title="출금신청">출금신청</a></li>
                                    <li><a href="deposit_details" title="입출금 내역">입출금 내역</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="menu-item">
                                ...
                                <ul class="depth2">
                                    <li><a href="cust_details_req" title="고객센터">1:1 문의하기</a></li>
                            ...
                            <div class="con">
                                ...
                                <div class="quick-menu-link">
                                    <!-- <div class="quick-menu">
                                        <a href="w_customer/prize_info" class="item"><img src="asset/images/ico_quick2_01.png" alt="당첨금 수령안내" />
            ...
            <?php else : ?>
                ...
                <div class="max-wrapper">
                    <h1 class="gnb-logo"><a href="index" title="로또캠프"><img src="asset/images/powerTTO2.jpg" alt="로또캠프"></a></h1>
                    ...
                    <nav class="gnb">
                        ...
                        <div class="sub-menu">
                            ...
                            <a href="join_02.php" title="회원가입">회원가입</a>
                            <a href="javascript:void(0)" class="btn-nav  btn-nav-close2"><img src="./asset/images/btn_menu_close.png" alt="메뉴 닫기"></a>
                        </div>

                        <ul class="gnb-menu">
                            <li class="menu-item">
                                <span class="gnb-btn" style="cursor:pointer"><a href="lotto_pb" title="파워 어게인">파워또구매</a></span>
                                <ul class="depth2">
                            ...
                            <li class="menu-item">
                                <span class="gnb-btn" style="cursor:pointer"><a href="winners_board" title="당첨자게시판">당첨자게시판</a></span>
                                <ul class="depth2">
                                </ul>
                            </li>
                            ...
                            <li class="menu-item">
                                <span class="gnb-btn" style="cursor:pointer"><a href="winning_statistics" title="당첨번호&amp;통계">당첨번호&amp;통계</a></span>
                                <ul class="depth2">
                                </ul>
                            </li>
                            ...
                            <li class="menu-item">
                                <span class="gnb-btn" style="cursor:pointer"><a href="customer_service" title="고객센터">고객센터</a></span>
        ...
        <script>
            function check_session_id() {
                let session_id = "<?php echo $_SESSION['loggedInUser']['verify_token']; ?>"
